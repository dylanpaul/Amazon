...
CREATE TABLE Users
(id INT NOT NULL GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, -- copied this 'generated by default structure from the skeleton code, unsure of exact functionality
email VARCHAR(256) NOT NULL UNIQUE,
addy VARCHAR(256) NOT NULL,
